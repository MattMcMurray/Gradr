...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, LoginResult> {
        ...
        @Override
        protected void onPostExecute(final LoginResult results) {
            mAuthTask = null;
            showProgress(false);
    ...
    /*
        This class allows us to have return values similar to those we have in javascript within
        the AsyncTask class.

        We return the username and id upon success
        We return the negated error code and the associated message upon error
     */
    public class LoginResult {
        private int integer;
        private String string;

        public LoginResult(int integer, String str) {
